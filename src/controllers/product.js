...
const update = async (req, res, next) => {
  const { id } = req.params;
  const { name, brand, price, stock, image, description, quantity, comments } =
    req.body;
...
/* Tenemos que llamar al endpoint post->localhost:8000/product/bulk 
y le pasamos por body en formato json los products y categories de la carpeta data.
Los usuarios se crean haciendo un get de user get->localhost:8000/user  */
